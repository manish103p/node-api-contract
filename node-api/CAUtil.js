...
exports.buildCAClient = (FabricCAServices, ccp, caHostName) => {
	...
	const caClient = new FabricCAServices(caInfo.url, caInfo.caName);
...
exports.registerAndEnrollUser = async (caClient, wallet, orgMspId, userId, affiliation, role) => {
	try {
